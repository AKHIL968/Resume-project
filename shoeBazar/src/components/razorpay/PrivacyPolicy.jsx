...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto p-4 text-gray">
      ...
      <h2 className="text-xl font-bold mt-4 text-blue">
      ...
      <h2 className="text-xl font-bold mt-4 text-blue">SECTION 2 - CONSENT</h2>
      <h3 className="text-lg font-bold mt-2 text-blue">How do you get my consent?</h3>
      <p>
      ...
      <h3 className="text-lg font-bold mt-2 text-blue">How do I withdraw my consent?</h3>
      <p>
        ...
        <a
          href="mailto:info@shoebazar.com"
      ...
      <h2 className="text-xl font-bold mt-4 text-blue">SECTION 3 - DISCLOSURE</h2>
      <p>
        We may disclose your personal information if we are required by law to
        do so or if you violate our Terms of Service.
      </p>

      <h2 className="text-xl font-bold mt-4 text-blue">SECTION 4 - PAYMENT</h2>
      <p>
      ...
      <h3 className="text-lg font-bold mt-2 text-blue">Links</h3>
      <p>
      ...
      <h2 className="text-xl font-bold mt-4 text-blue">SECTION 6 - SECURITY</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-4 text-blue">SECTION 7 - COOKIES</h2>
      <p>
        We use cookies to maintain the session of your user. It is not used to
        personally identify you on other websites.
      </p>

      <h2 className="text-xl font-bold mt-4 text-blue">SECTION 8 - AGE OF CONSENT</h2>
      <p>
